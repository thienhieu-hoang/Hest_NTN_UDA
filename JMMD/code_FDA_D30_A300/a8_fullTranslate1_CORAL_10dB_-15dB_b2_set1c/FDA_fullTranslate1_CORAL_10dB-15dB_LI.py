...
print("CORAL, reconstruction training first then domain adaptation training, domain weight 0.01 → 0.3, est weight 1.5 → 0.8, warmup epochs 80")
scheduler = WeightScheduler(strategy='reconstruction_first', start_domain_weight=0.01, end_domain_weight=0.3,

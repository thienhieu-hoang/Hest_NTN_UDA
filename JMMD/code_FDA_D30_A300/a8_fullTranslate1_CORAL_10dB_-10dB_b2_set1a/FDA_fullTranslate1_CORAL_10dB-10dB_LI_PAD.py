...
print("CORAL, reconstruction training first then domain adaptation training, domain weight 0.01 → 0.8, est weight 1.5 → 0.8, warmup epochs 80")
scheduler = WeightScheduler(strategy='reconstruction_first', start_domain_weight=0.01, end_domain_weight=0.8,
...
stage_name="CORAL extracted features"

pca_components = 256 # 24
pca_batch_size = 64
pca_refit_batches = 5 # 3
...
for sub_folder in sub_folder_:
    ...
    print("4 blocks, CORAL, extrac layers = blocks 2")
    # 

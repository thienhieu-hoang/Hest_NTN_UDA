...
from JMMD.helper.utils_GAN import post_val, train_step_cnn_residual_fda_fullTranslation1, val_step_cnn_residual_fda
...
for sub_folder in sub_folder_:
    ...
    for epoch in range(n_epochs):
        ...
        ##########################
        # 
        train_step_output = train_step_cnn_residual_fda_fullTranslation1(model, loader_H, loss_fn, optimizer, lower_range=-1, 
                        save_features=False, weights=weights, linear_interp=linear_interp,
                        fda_win_h=fda_win_h, fda_win_w=fda_win_w, fda_weight=fda_weight, flag_residual_reg=False)

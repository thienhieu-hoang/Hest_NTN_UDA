...
weights = {
    ...
    'est_weight': 0.3,          # Estimation loss weight (main task)
    'domain_weight': 5.0,       # JMMD loss weight (domain adaptation)
...
# Paths to save
path_temp = project_root + f'/JMMD/model/GAN_cal_A300_B100_300_tune_sameSNR/set6/'

...
# Paths to save
path_temp = project_root + f'/JMMD/model/GAN_onlySource_A300_B100_300_deep/{SNR}_dB/'
os.makedirs(os.path.dirname(path_temp), exist_ok=True)
idx_save_path = loader.find_incremental_filename(path_temp,'ver', '_', '')

save_model = False
model_path = project_root + f'/JMMD/model/GAN_onlySource_A300_B100_300/{SNR}_dB/ver' + str(idx_save_path) + '_'
...
for sub_folder in sub_folder_:
    ...
    # 
    model = DeeperGAN(n_subc=312, gen_l2=None, disc_l2=1e-5)  # l2 regularization for generator and discriminator
    # 

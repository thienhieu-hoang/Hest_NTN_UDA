...
scheduler = WeightScheduler(strategy='reconstruction_first', start_domain_weight=0.01, end_domain_weight=5.0,
...
from JMMD.helper.utils_GAN import GAN, Pix2PixGenerator
...
for sub_folder in sub_folder_:
    ...
    # 
    genertor = Pix2PixGenerator(dropOut_rate=0.1, dropOut_layers=['u1'])

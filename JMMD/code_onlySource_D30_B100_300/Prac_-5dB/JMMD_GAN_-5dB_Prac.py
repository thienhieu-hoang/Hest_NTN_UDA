...
# Paths to save
path_temp = project_root + f'/JMMD/model/GAN_onlySource_D30_B100_300/{SNR}_dB/'
os.makedirs(os.path.dirname(path_temp), exist_ok=True)
idx_save_path = loader.find_incremental_filename(path_temp,'ver', '_', '')

save_model = False
model_path = project_root + f'/JMMD/model/GAN_onlySource_D30_B100_300/{SNR}_dB/ver' + str(idx_save_path) + '_'

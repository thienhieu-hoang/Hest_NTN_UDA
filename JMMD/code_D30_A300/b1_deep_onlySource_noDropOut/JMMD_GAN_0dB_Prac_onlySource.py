...
from JMMD.helper.utils_GAN import GAN, DeeperGAN, DeeperPix2PixGenerator
...
for sub_folder in sub_folder_:
    ...
    # 
    generator = DeeperPix2PixGenerator(gen_l2=None, dropOut_layers=[])
    model = DeeperGAN(generator=generator, gen_l2=None, disc_l2=1e-5)  # l2 regularization for generator and discriminator
    # 

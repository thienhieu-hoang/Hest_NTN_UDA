...
from JMMD.helper.utils_GAN import GAN, DeeperGAN, Pix2PixGenerator, AttentionPix2PixGenerator, MultiScalePix2PixGenerator
...
for sub_folder in sub_folder_:
    ...
    # 
    generator = MultiScalePix2PixGenerator()

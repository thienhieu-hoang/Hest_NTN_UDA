...
sys.path.append(os.path.abspath(os.path.join(script_dir, 'helper')))
# import utils
# import loader
...
target_data_file_path = os.path.abspath(os.path.join(notebook_dir, '..', 'generatedChan', 'MATLAB', 'TDL_C_30', f'SNR_{SNR}dB','matlabNTN.mat'))
source_data_file_path = os.path.abspath(os.path.join(notebook_dir, '..', 'generatedChan', 'MATLAB', 'TDL_A_30', f'SNR_{SNR}dB','matlabNTN.mat'))
...
# Paths to save
path_temp = notebook_dir + f'/model/GAN_calcu_A30_C30/{SNR}_dB/'
os.makedirs(os.path.dirname(path_temp), exist_ok=True)
idx_save_path = loader.find_incremental_filename(path_temp,'ver', '_', '')

save_model = False
model_path = notebook_dir + f'/model/GAN_calcu_A30_C30/{SNR}_dB/ver' + str(idx_save_path) + '_'

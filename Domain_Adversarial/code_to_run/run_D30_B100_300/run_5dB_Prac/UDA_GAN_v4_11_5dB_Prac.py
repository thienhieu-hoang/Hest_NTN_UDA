...
# Paths to save
path_temp = notebook_dir + f'/model/GAN_cal_D30_B100_300/{SNR}_dB/'
os.makedirs(os.path.dirname(path_temp), exist_ok=True)
idx_save_path = loader.find_incremental_filename(path_temp,'ver', '_', '')

save_model = True
model_path = notebook_dir + f'/model/GAN_cal_D30_B100_300/{SNR}_dB/ver' + str(idx_save_path) + '_'
...
if load_checkpoint:
    # model_path = notebook_dir + '/model/GAN_cal_D30_B100_300/ver' + str(idx_save_path-1) + '_' # or replace idx_save_path-1 by the desired folder index
    model_path = notebook_dir + f'/model/GAN_cal_D30_B100_300/{SNR}_dB/ver' + str(idx_save_path-1) + '_'
else:
    model_path = notebook_dir + f'/model/GAN_cal_D30_B100_300/{SNR}_dB/ver' + str(idx_save_path) + '_'
if load_checkpoint:
